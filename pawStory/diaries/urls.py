...
urlpatterns = [
    ...
    path('diary', DiaryCreateView.as_view(), name='diary-create'), # 일기 작성
    path('diary/<int:id>/like', DiaryLikeCreateView.as_view(), name='diary-like'), # 일기 좋아요
    path('diary/<int:id>/like', DiaryLikeDeleteView.as_view(), name='diary-unlike'), #  일기 좋아요 취소
    path('diary/<int:id>/comments', DiaryCommentCreateView.as_view(), name='diary-comment-create'), # 일기 댓글 작성
    path('diary/<int:id>/comments', DiaryCommentListView.as_view(), name='diary-comment-list'), # 일기 댓글 조회
